...
using static OrderManager.Class.DataValidation;
    ...
    internal static class Ordini
    {
        ...
        internal static class GestioneOrdini
        {
            ...
            internal static void UpdateCalendarOnObj(long idordine, Outlook.Folder personalCalendar, SQLiteConnection connection = null)
            {
                ...
                if (!string.IsNullOrEmpty(ordinecode) && CalendarInteropOutlook.FindAppointment(personalCalendar, ordinecode, connection))
                {
                    ...
                    {
                        CalendarInteropOutlook.UpdateCalendar(personalCalendar, ordinecode, ordinecode, idordine, eta, false, connection);
                    }
                }
            }
        }
